...
router.put('/:id', authMiddleware, roleCheck(['instructor', 'admin', 'super-admin']), cohortController.updateCohort);
router.delete('/:id', authMiddleware, roleCheck(['instructor', 'admin', 'super-admin']), cohortController.deleteCohort);
